base = '''<html>
  <head>
	...
	<body>
		...
		<h3><span><img src="./assets/image1.png" class="snowflake"/></span> What is Snowflake?</h3>
		<p>
		...
		<h3><img src="./assets/image1.png" class="snowflake"/> Why trust Snowflake?</h3>
		<p>
		...
		<h3><img src="./assets/image1.png" class="snowflake"/> 4 reasons to use Snowflake for data sharing</h3>
		<ul>
		...
		<h3><img src="./assets/image1.png" class="snowflake"/> How does Snowflake Data Sharing work?</h3>
		<p>
		...
		<h3><img src="./assets/image1.png" class="snowflake"/> Terms and definitions</h3>
		<p>
		...
		<h3><img src="./assets/image1.png" class="snowflake"/> How to receive data from ProviderName on Snowflake</h3>
...
end='''<h4 class="end"><img src="./assets/image1.png" class="snowflake"/> Learn more about Snowflake Collaboration and Secure Data Sharing at <a href="https://www.snowflake.com/en/data-cloud/workloads/collaboration/" class="end">snowflake.com/en/data-cloud/workloads/collaboration</a></h3>
		<p class="legal">
